//
//  MZRecommendViewController.swift
//  MZITU
//
...
let MZRecommendCellIdentifier = "MZRecommendCellIdentifier"

class MZRecommendViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,SKPhotoBrowserDelegate {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(UINib.init(nibName: "MZHotCell", bundle: nil), forCellWithReuseIdentifier: MZRecommendCellIdentifier)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: MZRecommendCellIdentifier, for: indexPath) as! MZHotCell
